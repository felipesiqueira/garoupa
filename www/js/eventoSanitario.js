		...
		db.transaction(function (tx) 
		{
			...
			db.transaction(function (tx) 
			{
				...
				{ 
					...
					{											
						var dados = [ resultSet.rows.item(x).evento_sanitario, '<a href="editEventoSanitario.html?id_evento_sanitario='+resultSet.rows.item(x).id_evento_sanitario+'"><img src="img/edit.png" class="iconeTable"></a>'];		
			...
			db.transaction(function(tx, results) 
			{
				...
				{ 
					...
					{ 
						...
						tx.executeSql('INSERT INTO t_eventos_sanitarios VALUES (?,?,?,?,?,?)', [null, nome, hash, user, sync, id_fazenda]);		
					});
				});
